    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <nav class="nav-desktop">
                ...
                <a href="{{ route('front.salons.list') }}" class="nav-link">مراكز التجميل</a>
                ...
                @auth
                    <div class="d-flex align-items-center">
                        ...
                        <div class="custom-dropdown">
                            <button id="profile-btn" class="custom-dropdown-btn" type="button">
                                <i class="fas fa-user ms-1"></i>{{ $user->name }}
                                <i class="fas fa-caret-down mt-1 me-2"></i>
                            </button>
                            <ul id="profile-menu" class="custom-dropdown-menu">
                                <li><a href="{{ route('front.profile.account') }}">حسابي</a></li>
                                <li><a href="{{ route('front.profile.bookings') }}">حجوزاتي</a></li>
                                <li><a href="{{ route('front.profile.favourites') }}">المفضلة</a></li>
            ...
            <div class="mobile-auth-buttons">
                @auth
                    <div class="d-flex align-items-center mb-5">
                        <div class="custom-dropdown" id="mobile-profile-header">
                            <button id="mobile-profile-btn" class="custom-dropdown-btn" type="button">
                                <i class="fas fa-user "></i>{{ $user->name }}
                                <i class="fas fa-caret-down"></i>
                            </button>
                            <ul id="mobile-profile-menu" class="custom-dropdown-menu">
                                <li><a href="{{ route('front.profile.account') }}">حسابي</a></li>
                                <li><a href="{{ route('front.profile.bookings') }}">حجوزاتي</a></li>
                                <li><a href="{{ route('front.profile.favourites') }}">المفضلة</a></li>
                                @if (!Auth::user()->hasVerifiedEmail())
