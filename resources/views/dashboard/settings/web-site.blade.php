...
@push('styles')
      ...
      <style>
        .ck-editor__editable {
            min-height: 500px !important; /* تكبير الارتفاع للضعف (200px بدلاً من 100px افتراضي) */
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="settingsTabContent">
                                ...
                                @foreach ($services as $service)
                                    <div class="border-bottom pb-4">
                                        <form action="{{ route('dashboard.settings.updateService', $service) }}"
                                            class="row g-3 mb-4" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-3 me-5">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" name="status"
                                                        style="width: 20px; height:20px;" class="form-check-input mt-3 "
                                        ...
                                        <div class="digital-add needs-validation">
                                            <div class="form-group mb-0">
                                                <div class="description-sm">
                                                    <textarea dir="rtl" id="editor1" name="terms_content" cols="100" rows="10" style="display: none;">
                                                            ...
                                                            <div class="ck ck-sticky-panel" lang="ar"
                                                                ...
                                                                <div class="ck ck-sticky-panel__content" lang="ar"
                                                                    ...
                                                                    <div class="ck ck-toolbar ck-toolbar_grouping"
                                                                        ...
                                                                        lang="ar" dir="rtl">
                                                                        <!-- أدوات التحرير يمكن إضافتها هنا إذا لزم الأمر -->
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="privacy" role="tabpanel">
                                <form action="{{ route('dashboard.settings.updatePrivacy') }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="privacy_description" class="form-control" rows="6">{{ old('privacy_description', $legalSettings['privacy_description'] ?? '') }}</textarea>
                                    </div>
                                    ...
                                    <div id="privacy-sections-container">
                                        ...
                                        @foreach ($privacySections as $i => $section)
                                            <div class="col-md-12 row">
                                                <form action="{{ route('dashboard.settings.updatePrivacy') }}"
                                                    method="POST" class="col-md-12 row">
                                                    @csrf
                                                    ...
                                                    <div class="col-md-5">
                                                        <textarea name="privacy_sections[{{ $i }}][content]" class="form-control" dir="rtl" rows="3"
                                                            placeholder="{{ __('dashboard.section_content') }}">{{ $section['content'] ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-md-2 mt-2 button-group">
                                                        <button type="submit" class="btn btn-primary btn-air-primary">
                                        ...
                                        <div class="col-md-12 row">
                                            <form action="{{ route('dashboard.settings.updatePrivacy') }}"
                                                ...
                                                <div class="col-md-5 mt-2">
                                                    <textarea name="privacy_sections[0][content]" class="form-control"
                            ...
                            <div class="tab-pane fade" id="faq" role="tabpanel">
                                ...
                                <div class="col-md-12 row">
                                    <label class="col-md-4 form-label">{{ __('dashboard.questions') }}</label>
                                    <label class="col-md-4 form-label">{{ __('dashboard.answer') }}</label>
                                    <label class="col-md-4 form-label">{{ __('dashboard.category') }}</label>
                                    <br>
                                    <div id="faq-questions-container">
                                        ...
                                        @foreach ($faqQuestions as $i => $q)
                                            <div class="col-md-12 row">
                                                <form action="{{ route('dashboard.settings.updateFaq') }}"
                                                    method="POST" class="row col-md-11 ">
                                                    @csrf
                                                    <div class="col-md-3 mb-2">
                                                        <input type="text"
                                                            name="faq_questions[{{ $i }}][question]"
                                                            value="{{ $q['question'] ?? '' }}" class="form-control"
                                                            placeholder="{{ __('dashboard.question') }}">
                                                    </div>
                                                    <div class="col-md-5 mb-2">
                                                        <textarea name="faq_questions[{{ $i }}][answer]" class=" form-control"
                                                            placeholder="{{ __('dashboard.answer') }}">{{ $q['answer'] ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-md-3 mb-2">
                                                        <input type="text"
                                                            name="faq_questions[{{ $i }}][category]"
                                                            value="{{ $q['category'] ?? '' }}" class="form-control"
                                        ...
                                        <form action="{{ route('dashboard.settings.updateFaq') }}" method="POST"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <textarea name="faq_questions[0][answer]" class="form-control" placeholder="{{ __('dashboard.answer') }}"></textarea>
                                            </div>
                                            <div class="col-md-3 mb-2">
