                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="userDetailTabContent">
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-s-12 col-md-4 text-center mb-4">
                                        <div class="user-profile-image">
                                            <img src="{{ $user->url }}" alt="{{ $user->name }}" class="rounded-circle"
                                        ...
                                        <div class="user-details">
                                            <div class="row">
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.full_name') }}:</label>
                                                        <p>{{ $user->name }}</p>
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.email_address') }}:</label>
                                                        <p>{{ $user->email }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.account_status') }}:</label>
                                                        <p>
                                                            <span
                                                ...
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.email_verified') }}:</label>
                                                        <p>
                                                            <span
                                                                class="badge bg-{{ $user->email_verified_at ? 'success' : 'warning' }}">
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.account_created') }}:</label>
                                                ...
                                                <div class="col-6 col-md-6">
                                                    <div class="detail-item mb-3">
                                                        <label
                                                            class="fw-bold text-muted">{{ __('dashboard.last_updated') }}:</label>
                                ...
                                <div class="row mt-4 g-2">
                                    <div class="col-6 col-md-3 d-flex mb-3">
                                        <a href="{{ route('dashboard.users.edit', $user->id) }}"
                                            class="btn btn-primary flex-fill py-3 h-100">
                                    ...
                                    <div class="col-6 col-md-3 d-flex mb-3">
                                        <a href="{{ route('dashboard.users.editRoles', $user->id) }}"
                                            class="btn btn-info w-100 h-100 flex-fill py-3 ">
                                    ...
                                    <div class="col-6 col-md-3 d-flex ">
                                        <form action="{{ route('dashboard.users.toggleStatus', $user) }}" method="POST"
                                            ...
                                            @method('PATCH')
                                            <button type="submit"
                                                class="btn btn-{{ $user->is_active ? 'warning' : 'success' }} flex-fill py-3 h-100 w-100"
                                    ...
                                    <div class="col-6 col-md-3 d-flex">
                                        <form action="{{ route('dashboard.users.destroy', $user) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger flex-fill py-3 h-100 w-100"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card bg-info text-white">
                                                <div class="card-body text-center">
                                                    <h4>{{ $statistics['last_session'] ? $statistics['last_session']->started_at->diffForHumans() : __('dashboard.never') }}
                                                    </h4>
                                    ...
                                    @forelse($sessions as $session)
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <div class="row align-items-center">
                                                    <div class="col-md-3">
                                                        ...
                                                        <span
                                                            class="text-muted">{{ Str::limit($session->session_id, 20) }}</span>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <strong>{{ __('dashboard.device') }}:</strong>
                                                        <span
                                                            class="badge bg-secondary">{{ ucfirst($session->device_type) }}</span>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <strong>{{ __('dashboard.country') }}:</strong>
                                                        <span
                                                            class="text-muted">{{ $session->country ?? __('dashboard.unknown') }}</span>
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <span class="text-muted">
                                                            @php
                                                                $totalSeconds = $session->started_at->diffInSeconds(
                                                                    $session->updated_at,
                                                                );
                                            ...
                                            <div class="collapse" id="visits-{{ $session->id }}">
                                                <div class="card-body">
                                                    <h6 class="mb-3">{{ __('dashboard.page_visits_in_session') }}
                                                                ...
                                                                <tbody>
                                                                    @foreach ($session->visits as $visit)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $visit->visited_at->format('M j, Y g:i A') }}
                                                                            </td>
                                                                            <td>
                                                                                @if ($visit->time_spent)
                                                                                    {{ gmdate('H:i:s', $visit->time_spent) }}
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::parse($visit->visited_at)->diffForHumans() }}
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                    ...
                                                    @else
                                                        <p class="text-muted">{{ __('dashboard.no_page_visits_session') }}
                                                        </p>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="bookings" role="tabpanel" aria-labelledby="bookings-tab">
                                <x-dashboard.user-bookings-tab :user="$user" :bookings="$bookings" :statistics="$bookingStatistics" />
                            </div>
                        </div>
                    </div>
                </div>
