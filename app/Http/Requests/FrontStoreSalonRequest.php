...
class FrontStoreSalonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'logo' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:6200',
            'cover_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:6200',
            'gallery_images.*' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:6200',
    ...
    public function messages()
    {
        return [
            ...
            'logo.max' => 'حجم شعار الصالون يجب ألا يتجاوز 6 ميغابايت.',
